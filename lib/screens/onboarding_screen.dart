...
final List<OnBoard> demo_data = [
  ...
  OnBoard(
    ...
    description: "platypuses are small, shy animals. They have a flattened head and body to help them glide through the water. Their fur, dark brown on top and tan on their bellies, is thick and repels water to keep them warm and dry even after hours of swimming."),
  OnBoard(
